...
namespace ECommerceCore.Migrations
{
    ...
    [Migration("20191129121642_AddedForeignKeyForProductModel")]
    partial class AddedForeignKeyForProductModel
    {
            ...
            modelBuilder.Entity("ECommerceCore.Models.Product", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            ...
                            Price = 5.0,
                            Quantity = 12,
                            ReleaseDate = new DateTime(2019, 11, 29, 14, 16, 42, 244, DateTimeKind.Local).AddTicks(7556),
